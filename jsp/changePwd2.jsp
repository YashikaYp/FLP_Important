...
<body>
	...
	<form action="#" method="post">
		<div class="banner-bootom-w3-agileits">
			<div class="container">
				<div class="col-md-7 col-md-offset-3 cart-table">
					<div class="col-md-12">
					...
					<div class="col-md-12" style="margin-top: 1em">
						<div class="col-md-4">Enter Old Password</div>
						<div class="col-md-4">
							<input type="password" name="pwd1" value="" id="pwd1"
								style="color: black" />
						</div>
					</div>
					<div class="col-md-12" style="margin-top: 1em">
						...
						<div class="col-md-4">
							<input type="password" name="pwd2" value="" id="pwd2"
								style="color: black" />
						</div>
					</div>
					<div class="col-md-12" style="margin-top: 1em">
						...
						<div class="col-md-4">
							<input type="password" name="pwd3" value="" id="pwd3"
								style="color: black" />
						</div>
					</div>
