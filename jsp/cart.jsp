	...
	<div class="banner-bootom-w3-agileits">
		...
		<div class="col-md-12 cart-table">					
			<table class="table">				
				<tbody>
					<tr>
						<td class="col-md-2"><img src="/images/d1.jpg" class="img-thumbnail img-responsive"/></td>
						<td class="col-md-8 "><h4 class="product">Product Name</h4><br/>Price * Quantity</td>
						<td class="col-md-2"><div class="remove">&times</div></td>
					</tr>
					<tr>
						<td class="col-md-2"><img src="/images/d2.jpg" class="img-thumbnail img-responsive"/></td>
						<td class="col-md-8"><h4 class="product">Product Name</h4><br/>Price * Quantity</td>
						<td class="col-md-2"><div class="remove">&times</div></td>
					</tr>
					<tr>
						<td class="col-md-2"><img src="/images/d3.jpg" class="img-thumbnail img-responsive"/></td>
						<td class="col-md-8"><h4 class="product">Product Name</h4><br/>Price * Quantity</td>
						<td class="col-md-2"><div class="remove">&times</div></td>
					</tr>
				</tbody>
